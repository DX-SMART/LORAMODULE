...
A: No. The LoRa module does not support user-side firmware upgrades. If a firmware upgrade is required, please contact us and return the module to our company. Our technical team will perform the firmware upgrade.
...
If the required frequency is outside the supported range, please contact us to discuss customization.


### LORA-004 — Firmware Programming Failure
